...
```{r}
# breast cancer
brca <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/brca_info.csv")
  
# colon cancer
crc <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/crc_info.csv")
  
# glioblastoma
gbm <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/gbm_info.csv")
  
# esophageal cancer
esca <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/esca_info.csv")

# hepatitis B virus infection
hbv <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/hbv_info.csv")

# liver cancer
hcc <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/hcc_info.csv")

# stomach cancer
stad <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/stad_info.csv")

# healthy 
hea <- read.csv("C:/Users/User/Box Sync/Projects/Multi_Cancer/Raw_Data/hea_info.csv")
```
...
table(mc_data$diagnosis)/276*100
table(mcTrain$diagnosis)/223*100
table(mcTest$diagnosis)/53*100
