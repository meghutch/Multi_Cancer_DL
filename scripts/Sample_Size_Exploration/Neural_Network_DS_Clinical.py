...
# 
# ## **Deep Learning Approaches for Cancer Classification - DS Clinical Data**
# 
# **Author:** Meg Hutch
# 
# **Date:** March 1, 2020
...
# Training set
mcTrain_x = pd.read_csv('02_Processed_Data/Final_Datasets/mcTrain_x_ds_70_30.csv')
mcTrain_y = pd.read_csv('02_Processed_Data/Final_Datasets/mcTrain_y_ds_70_30.csv')
# Testing set
#mcTest_x = pd.read_csv('02_Processed_Data/Final_Datasets/mcTest_x_ds_70_30.csv')
#mcTest_y = pd.read_csv('02_Processed_Data/Final_Datasets/mcTest_y_ds_70_30.csv')
# Principal Components that make up 90% of the variance of the training set
pca_Train = pd.read_csv('02_Processed_Data/Final_Datasets/pca_train_DS_70_30.csv')
# Principal Components projected onto the test set
#pca_Test = pd.read_csv('02_Processed_Data/Final_Datasets/pca_test_DS_70_30.csv')
...
for index in range (0, 212): # 212 observations when we downsample healthy patients 
    ...
    model = nn.Sequential(nn.Linear(140, 50),
                          nn.ReLU(),
                          nn.Linear(50, 7))
